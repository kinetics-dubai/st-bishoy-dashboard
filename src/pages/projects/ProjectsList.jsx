...
import { Card, Table, Button, Space, Popconfirm, Empty, message, Avatar } from 'antd';
...
export default function ProjectsList() {
  ...
  const { projects, loading, error, deleting } = useSelector((state) => state.projects);
  ...
  const columns = [
    ...
    },
    {
      ...
      ellipsis: true,
      render: (_, record) => {
        const desc = i18n.language === 'ar' && record.description_ar
      ...
      render: (_, record) => (
        <Space>
          ...
          <Popconfirm
            ...
            description={t('projects.deleteConfirm', { title: getTitle(record) })}
