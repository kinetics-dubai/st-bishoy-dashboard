...
export default function MonkForm() {
  ...
  const { currentMonk, loading, creating, updating } = useSelector(
    (state) => state.monks,
  );
    ...
    >
      ...
      >
            ...
            <Col xs={24} md={12}>
              ...
              >
                <Input
                  size="large"
                  dir="rtl"
                  placeholder={t("monk.nameArPlaceholder")}
                />
              </Form.Item>
            </Col>
            <Col xs={24} md={12}>
              ...
              >
                <Input
                  size="large"
                  placeholder={t("monk.positionPlaceholder")}
                />
              </Form.Item>
            </Col>
            <Col xs={24} md={12}>
              ...
              >
                <Input
                  size="large"
                  dir="rtl"
                  placeholder={t("monk.positionArPlaceholder")}
                />
              </Form.Item>
            </Col>
            <Col xs={24} md={12}>
            ...
            <Col xs={24} md={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: t("validation.required", { field: t("monk.bio") }),
                  },
                  {
                    max: 2000,
                    message: t("validation.maxLength", {
              ...
              >
                <TextArea
                  rows={6}
                  placeholder={t("monk.bioPlaceholder")}
                  showCount
                  maxLength={2000}
                />
              </Form.Item>
            ...
            <Col xs={24} md={12}>
              ...
              >
                <TextArea
                  rows={6}
                  dir="rtl"
                  placeholder={t("monk.bioArabicPlaceholder")}
                  showCount
                  maxLength={2000}
                />
              </Form.Item>
        ...
        <FormSection
          ...
          title={t("monk.importantDates")}
        >
          <Form.Item
            label={t("monk.departed")}
            name="departed"
            valuePropName="checked"
          >
            <Switch
              checkedChildren={t("monk.departedYes")}
              unCheckedChildren={t("monk.departedNo")}
            />
          </Form.Item>
        </FormSection>
      </Form>
