...
function normalizeEntity(entity) {
  ...
  const normalizedParent = entity.parent ? normalizeEntityLink(entity.parent) : null;
  ...
  return {
    ...
    overview_description_ar: entity.overview_description_ar || overview.description_ar,
    ...
    entity_description_ar: entity.entity_description_ar || details.description_ar,
    entity_description_image: entity.entity_description_image || details.image,
    entity_location_description: entity.entity_location_description || location.description,
    entity_location_description_ar: entity.entity_location_description_ar || location.description_ar,
    entity_landmarks_description: entity.entity_landmarks_description || landmarks.description,
    entity_landmarks_description_ar: entity.entity_landmarks_description_ar || landmarks.description_ar,
    ...
    childrenCount: typeof entity.childrenCount === 'number' ? entity.childrenCount : normalizedChildren.length,
  };
}
